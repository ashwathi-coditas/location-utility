 ...
 */
public class FourSquareServiceImpl implements GeoProviderService {

    private final Logger log = LoggerFactory.getLogger(FourSquareServiceImpl.class);
    ...
    public List<PlaceDTO> getPlaces(LocationFilterDTO locationFilterDTO) {
        ...
        if (locationFilterDTO.getCategoryName() != null && placeDTOS.size() > 0) {
