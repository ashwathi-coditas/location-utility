 ...
 *
 * @see GeoProviderServiceImpl
 */
@RunWith(MockitoJUnitRunner.class)
@ContextConfiguration(loader = AnnotationConfigContextLoader.class)
public class GeoProviderServiceTest {
    private static final String clientId = "GYDX3XXR2MOWTOUH21G3JT4LIVU21RRASZGXZAHP3NYTJB14";
    private static final String clientSecret = "SUOCQBTNJQSD5HMMYNMNHSTP2ET01SE2DKCLBPDS1FLNLVNF";
    private static final String foursquareAPI = "https://api.foursquare.com/v2/venues/";
    ...
    @InjectMocks
    GeoProviderServiceImpl geoServiceProvider;
    ...
    public void testGetLocationByName() {
        ...
        LocationDTO locationDTO = geoServiceProvider.getLocationByName("chicago");
